...
# Paths relative to the repo root (one level up from src/)
...
# Database configuration — defaults to SQLite if no DB_HOST is set
...
if db_host:
    ...
    db_path = os.path.join(os.path.dirname(__file__), 'data', 'plex_portal.db')
